...
(function () {
  ...
  var endpointURL = 'https://makeup-api.herokuapp.com/api/v1/products.json?product_type=nail_polish';
  var localEndpoint = 'https://nail-polish.glitch.me/backup';
  var container = document.getElementsByTagName('main')[0];

  var colors = [];
  axios.get(localEndpoint).then(function (response) {
    ...
    response.data.forEach(function (product) {
      if (product.product_colors.length > 0) {
        product.product_colors.forEach(function (color) {
          colors.push('<a class="color" data-name="' + color.colour_name + '" data-hex="' + color.hex_value + '" style="background-color:' + color.hex_value + ';" href="' + product.product_link + '">\n                <b>' + product.brand + '</b>\n                <i>' + color.colour_name + '</i>\n              </a>');
        });
      };
    });
